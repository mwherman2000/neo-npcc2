...
using NPC.mwherman2000.NeoDraw.Contract;

/// <summary>
/// NPC.mwherman2000.NeoDraw.Contract.NeoCounter Custom Methods
///
...
namespace NPC.mwherman2000.NeoDraw.Contract
{
    public partial class NeoCounter    
    {
        ...
        public static BigInteger GetCurrentNextNumber(NeoVersionedAppUser vau, NeoCounters counter)
        {
            BigInteger result = -1;
