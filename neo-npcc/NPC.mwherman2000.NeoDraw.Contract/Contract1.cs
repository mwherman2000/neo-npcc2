...
using static NPC.mwherman2000.NeoDraw.Contract.NeoCounter;

namespace NPC.mwherman2000.NeoDraw.Contract
{
    public class Contract1 : SmartContract
    {
        const string SmartContractName = "NPC.mwherman2000.NeoDraw.Contract";
        const string SmartContractNameVersion = SmartContractName + " " + "v1.0.3";
        ...
        public static object[] Main(string operation, string entity, object[] args)
        {
            ...
            //NeoVersionedAppUser AppVAU = NeoVersionedAppUser.New(SmartContractName, 1, 1, 1, NeoEntityModel.GetInvokingAddressScriptHash());
            //NeoVersionedAppUser AppVAU = NeoVersionedAppUser.New(SmartContractName, 1, 1, 1, ExecutionEngine.ExecutingScriptHash);
            NeoVersionedAppUser AppVAU = NeoVersionedAppUser.New(SmartContractName, 1, 1, 1, "7074acf3f06dd3f456e11053ebf61c5b04b07ebc".AsByteArray()); // DEBUG ONLY
